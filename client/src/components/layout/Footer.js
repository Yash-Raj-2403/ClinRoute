      ...
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-tagline">
              RAG-powered healthcare navigation. Get the right care, at the right time.
            </p>
          ...
          <div className="footer-links-section">
            ...
            <ul>
              ...
              <li><Link to="/about">About ClinRoute</Link></li>
              <li><Link to="/security">Security & Compliance</Link></li>
              <li><a href="#">RAG Technology</a></li>
            </ul>
          </div>
          ...
          <div className="footer-links-section">
            ...
            <ul>
              ...
              <li><Link to="/for-hospitals">For Hospitals</Link></li>
        ...
        <div className="footer-app-section">
          <div className="app-info">
            <h4>Get the ClinRoute App</h4>
            <p>Access RAG-powered triage, find doctors, and manage your health on the go.</p>
          </div>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} ClinRoute, Inc. All rights reserved.</p>
