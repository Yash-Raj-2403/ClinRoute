...
const AccountSettings = () => {
  ...
  return (
    <div className="max-w-[1600px] mx-auto min-h-screen pb-20 px-6">
      <div className="mb-12">
         <h1 className="text-5xl font-serif font-bold text-primary-600 mb-4 tracking-tight">Settings</h1>
               ...
               <div className="space-y-12">
                  <div className="flex items-center gap-8 pb-10 border-b border-slate-100">
                     <div className="relative group cursor-pointer">
                        <div className="w-32 h-32 rounded-full bg-[#FFE4E6] flex items-center justify-center text-[#BE123C] font-serif font-bold text-5xl shadow-xl ring-8 ring-slate-50 group-hover:ring-[primary-600]/10 transition-all">
                           {user?.name?.charAt(0) || 'P'}
                        </div>
                        <div className="absolute bottom-0 right-0 p-3 bg-primary-600 text-white rounded-full shadow-lg hover:scale-110 transition-transform">
                           <Camera size={20} />
                        </div>
                     </div>
                     <div>
                        <h2 className="text-4xl font-serif font-bold text-primary-600 mb-2">{user?.name || 'Patient Name'}</h2>
                  ...
                  <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                     <div className="space-y-3">
                        ...
                        <div className="relative group">
                           <User className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary-600 transition-colors" size={22} />
                           <input type="text" defaultValue={user?.name} className="w-full pl-16 pr-6 py-5 bg-slate-50 border-2 border-transparent rounded-[2rem] focus:bg-white focus:border-primary-600/20 focus:ring-0 outline-none font-bold text-lg text-slate-800 transition-all" />
                        </div>
                     </div>
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="relative group">
                           <Mail className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary-600 transition-colors" size={22} />
                           <input type="email" defaultValue={user?.email} className="w-full pl-16 pr-6 py-5 bg-slate-50 border-2 border-transparent rounded-[2rem] focus:bg-white focus:border-primary-600/20 focus:ring-0 outline-none font-bold text-lg text-slate-800 transition-all" />
                        </div>
                     </div>
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="relative group">
                           <Phone className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary-600 transition-colors" size={22} />
                           <input type="tel" placeholder="+1 (555) 000-0000" className="w-full pl-16 pr-6 py-5 bg-slate-50 border-2 border-transparent rounded-[2rem] focus:bg-white focus:border-primary-600/20 focus:ring-0 outline-none font-bold text-lg text-slate-800 transition-all" />
                        </div>
                     </div>
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="relative group">
                           <MapPin className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary-600 transition-colors" size={22} />
                           <input type="text" placeholder="New York, NY" className="w-full pl-16 pr-6 py-5 bg-slate-50 border-2 border-transparent rounded-[2rem] focus:bg-white focus:border-primary-600/20 focus:ring-0 outline-none font-bold text-lg text-slate-800 transition-all" />
                        </div>
                     </div>

                     <div className="md:col-span-2 pt-8 flex justify-end border-t border-slate-100">
                        <button className="px-10 py-5 bg-primary-600 text-white rounded-full font-bold text-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center gap-3">
                           <Save size={22} />
                           Save Changes
                        </button>
                     </div>
